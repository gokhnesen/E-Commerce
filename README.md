...
Bu proje, .NET ve Angular teknolojilerinde kendimi geliştirmek amacıyla geliştirdiğim bir **e-ticaret uygulamasıdır**.  
Amacım, hem backend hem de frontend tarafında **gerçek dünyada kullanılan teknolojileri** deneyimlemek ve modern yazılım geliştirme pratiklerini öğrenmektir.  
...
## 🚀 Amaç
Bu proje ticari bir ürün değildir.  
Amacım, **gerçek dünyada kullanılan teknolojileri junior bir geliştirici olarak öğrenmek**,  
kendi kendime bir e-ticaret uygulaması geliştirerek hem **backend hem de frontend** tarafında tecrübe kazanmaktır.  
