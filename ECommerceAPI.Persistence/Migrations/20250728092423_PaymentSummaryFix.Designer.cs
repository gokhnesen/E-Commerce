...
namespace ECommerceAPI.Persistence.Migrations
{
    ...
    [Migration("20250728092423_PaymentSummaryFix")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ECommerceAPI.Domain.Entities.Order.OrderItem", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("ECommerceAPI.Domain.Entities.Order.Order", b =>
                {
                    ...
                    b.OwnsOne("ECommerceAPI.Domain.Entities.Order.PaymentSummary", "PaymentSummary", b1 =>
                        {
                    ...
                    b.OwnsOne("ECommerceAPI.Domain.Entities.Order.ShippingAddress", "ShippingAddress", b1 =>
                        {
                            b1.Property<Guid>("OrderId")
                                .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("ECommerceAPI.Domain.Entities.Order.OrderItem", b =>
                {
                    b.HasOne("ECommerceAPI.Domain.Entities.Order.Order", null)
                        .WithMany("OrderItems")
                        .HasForeignKey("OrderId")
                        .OnDelete(DeleteBehavior.Cascade);

                    b.OwnsOne("ECommerceAPI.Domain.Entities.Order.ProductItemOrdered", "ItemOrdered", b1 =>
                        {
