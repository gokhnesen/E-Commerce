...
export const routes: Routes = [
    ...
    {path: 'product/:id', component: ProductDetails, data: { renderMode: RenderMode.Server }},
    {path: 'products/category/:slug', 
      loadComponent: () => import('./features/products/product-category/product-category').then(m => m.ProductCategory),
